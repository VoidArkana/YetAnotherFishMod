...
public class ArtemiaModel extends GeoModel<ArtemiaEntity> {
    ...
    public ResourceLocation getModelResource(ArtemiaEntity artemiaEntity) {
        return new ResourceLocation(YetAnotherFishMod.MOD_ID, "geo/artemia.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(ArtemiaEntity artemiaEntity) {
        if (artemiaEntity.isNinni()){
            return new ResourceLocation(YetAnotherFishMod.MOD_ID, "textures/entity/artemia/artemia_ninni.png");
        }else {
            return switch (artemiaEntity.getVariantSkin()){
                case 1 -> new ResourceLocation(YetAnotherFishMod.MOD_ID, "textures/entity/artemia/artemia_beavertail.png");
                case 2-> new ResourceLocation(YetAnotherFishMod.MOD_ID, "textures/entity/artemia/artemia_thai.png");
                default -> new ResourceLocation(YetAnotherFishMod.MOD_ID, "textures/entity/artemia/artemia.png");
            };
        }
    }
    ...
    public ResourceLocation getAnimationResource(ArtemiaEntity artemiaEntity) {
        return new ResourceLocation(YetAnotherFishMod.MOD_ID, "animations/artemia.animation.json");
    }
