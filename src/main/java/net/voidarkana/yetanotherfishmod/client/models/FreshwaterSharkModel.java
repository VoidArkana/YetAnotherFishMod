    ...
    public ResourceLocation getModelResource(FreshwaterSharkEntity fish) {
        if (fish.isBaby()){
            return switch (fish.getVariantModel()){
                case 1 -> new ResourceLocation(YetAnotherFishMod.MOD_ID, "geo/shark_highfin_juvenile.geo.json");
                case 2, 3 -> new ResourceLocation(YetAnotherFishMod.MOD_ID, "geo/shark_rainbow_juvenile.geo.json");
                default -> new ResourceLocation(YetAnotherFishMod.MOD_ID, "geo/shark_bala_juvenile.geo.json");
            };
        }else {
            return switch (fish.getVariantModel()){
                case 1 -> new ResourceLocation(YetAnotherFishMod.MOD_ID, "geo/shark_highfin_adult.geo.json");
                case 2 -> new ResourceLocation(YetAnotherFishMod.MOD_ID, "geo/shark_rainbow_adult.geo.json");
                case 3 -> new ResourceLocation(YetAnotherFishMod.MOD_ID, "geo/shark_rainbow_juvenile.geo.json");
                default -> new ResourceLocation(YetAnotherFishMod.MOD_ID, "geo/shark_bala_adult.geo.json");
            };
        }
    }
