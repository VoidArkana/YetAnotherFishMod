...
import net.voidarkana.yetanotherfishmod.common.worldgen.features.HornWortFeature;
...
public class YAFMConfiguredFeatures {
    ...
    public static final DeferredRegister<Feature<?>> MOD_FEATURES = DeferredRegister.create(ForgeRegistries.FEATURES, YetAnotherFishMod.MOD_ID);
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(YetAnotherFishMod.MOD_ID, name));
    }
