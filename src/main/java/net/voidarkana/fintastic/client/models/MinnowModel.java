...
public class MinnowModel extends GeoModel<MinnowEntity> {
    ...
    public ResourceLocation getModelResource(MinnowEntity barbfishEntity) {
        return switch (barbfishEntity.getVariantModel()){
            case 1 -> new ResourceLocation(Fintastic.MOD_ID, "geo/barbslim.geo.json");
            case 2 ->new ResourceLocation(Fintastic.MOD_ID, "geo/barbsmall.geo.json");
            case 3 ->new ResourceLocation(Fintastic.MOD_ID, "geo/rasbora.geo.json");
            default ->new ResourceLocation(Fintastic.MOD_ID, "geo/barb.geo.json");
        };
    }
