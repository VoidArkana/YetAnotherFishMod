...
public class GuppyLayer extends GeoRenderLayer<GuppyEntity> {

    public GuppyLayer(GeoRenderer<GuppyEntity> entityRendererIn) {
    ...
    public void render(PoseStack poseStack, GuppyEntity entity, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
            ...
            RenderType cameo = RenderType.entityCutoutNoCull(new ResourceLocation(YetAnotherFishMod.MOD_ID, "textures/entity/guppy/guppy_second_"+entity.getVariantSkin()+".png"));
